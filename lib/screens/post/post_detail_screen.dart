                            ...
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: new BorderRadius.only(
                                  topLeft:
                                      const Radius.circular(25.0), // 적절히 조절
                                  topRight:
                                      const Radius.circular(25.0), // 적절히 조절
                                ),
                              ),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    // 댓글
                    Column(children: [
                      _commentScreen.buildBody(context, postId, nickName),
                      SizedBox(
                        height: 200.0,
                      )
                    ]),
                                      ...
                                      onPressed: () {
                                        ...
                                        if (_formKey.currentState!.validate()) {
                                          CRUDController.to.createComment(
                                              commentText, uid, nickName, postId);
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                ListTile(
                  ...
                  onTap: () {
                    salesState = "판매중";
                    CRUDController.to.stateUpdateDoc(postId, salesState);
                    _bottomNavigationPageController.changePage(1);
                    Get.offAllNamed('/tap');
                  },
                ),
